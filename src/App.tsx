...
function App() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const apiResponse = await fetch('/api/generate-prescription', {
            method: 'POST',
        ...
        if (!apiResponse.ok) {
            throw new Error('AI Prescription API failed.');
        }

        const aiData = await apiResponse.json();

        // Use the data generated by the API
        setFinalPrescription(aiData);
